...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.example.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.example.security.DomainUserDetailsService", "createSpringSecurityUser");
